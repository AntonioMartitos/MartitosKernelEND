...
if [ "$TARGET" = "G920F" ] ; then
	export KERNEL_CONFIG="martitos-config";
fi;

# G925F
if [ "$TARGET" = "G925F" ] ; then
	export KERNEL_CONFIG="martitos-edge";
fi;
...
# system compiler
export CROSS_COMPILE=/home/antoniopirulero96/aarch64-linux-android-4.9/bin/aarch64-linux-android-
